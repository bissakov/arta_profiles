...
from family.custom_exceptions import FamilyNotFound, WrongIIN, WrongPassword, IINNotInSections, WrongPassword
...
def index() -> str:
    ...
    except (FamilyNotFound, WrongIIN, WrongPassword, IINNotInSections, WrongPassword) as e:
